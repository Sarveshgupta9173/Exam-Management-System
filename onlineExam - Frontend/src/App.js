...
import StudentPersonalResult from './components/students/studentPersonalResult';
  ...
  return (
    <div className="App">
      ...
      <Routes>
        ...
        <Route path="/studentPersonalResult" element={<StudentPersonalResult></StudentPersonalResult>}></Route>
      </Routes>
      </BrowserRouter>
    </div>
  );
