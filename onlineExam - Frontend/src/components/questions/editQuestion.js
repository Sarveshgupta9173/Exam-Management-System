...
const EditQuestion = (props) =>{
    ...
    useEffect(()=>{
        if(location.state.question_type === "PROGRAMMING"){
            setDisable(true);
    ...
    return(
        ...
        <Container maxWidth="md">
            ...
            <div className="inputs"  >
                ...
                onChange={handleChange} defaultValue={location.state.question} multiline rows={8}  sx={{width: '95%'}} ></TextField>
            </div>
            <div className="inputs"  >
                <QuestionAnswerIcon fontSize="large"></QuestionAnswerIcon>
                <TextField id="standard-basic" label="Enter Option A" name="option_A" variant="outlined" type="text" 
                onChange={handleChange} required disabled={disable} defaultValue={location.state.option_A} sx={{width:'95%'}}></TextField>
            </div>
            <div className="inputs"  >
                <QuestionAnswerIcon fontSize="large"></QuestionAnswerIcon>
                <TextField id="standard-basic" label="Enter Option B" name="option_B" variant="outlined" type="text" 
                onChange={handleChange} required disabled={disable} defaultValue={location.state.option_B} sx={{width:'95%'}}></TextField>
            </div>
            <div className="inputs"  >
                <QuestionAnswerIcon fontSize="large"></QuestionAnswerIcon>
                <TextField id="standard-basic" label="Enter Option C" name="option_C" variant="outlined" type="text" 
                onChange={handleChange} required disabled={disable} defaultValue={location.state.option_C} sx={{width:'95%'}}></TextField>
            </div>
            <div className="inputs"  >
                <QuestionAnswerIcon fontSize="large"></QuestionAnswerIcon>
                <TextField id="standard-basic" label="Enter Option D" name="option_D" variant="outlined" type="text" 
                onChange={handleChange} required disabled={disable} defaultValue={location.state.option_D} sx={{width:'95%'}}></TextField>
            </div>
            <div className="inputs">
